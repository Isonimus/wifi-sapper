...
- [feature] slice-7: alert surfaces — the shared surface event bus (ADR-0021) and the LED status surface shipped in slice-0022; remaining surfaces, each an additional bus subscriber touching no engine code: web dashboard, optional screen toast, push webhook (ntfy/Discord) (ADR-0021, ADR-0001)
