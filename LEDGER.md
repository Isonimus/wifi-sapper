...
- [feature] capture: RF sniffer channel hopping + AP discovery — slice-0012 shipped the fixed-channel promiscuous seam feeding the pure core (ADR-0011); still to add are band-sweeping channel hopping (with a dwell-time probe) and beacon-based AP discovery / target selection (ADR-0011)
