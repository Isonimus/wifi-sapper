...
- [feature] slice-6: wpa-sec cracked-download + hourly scheduler + per-BSSID manifest + new-password alerts (shares the STA session the slice-0018 drain brings up, ADR-0017 decision #6)
